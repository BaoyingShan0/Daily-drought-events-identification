...
%% Part 5: Plotting SPI
% taking years 2010-2020 as example
...
%         text(0.02, 0.85,  for_text, "FontSize", font_text-1, 'Units','normalized','HorizontalAlignment',"left","FontWeight","normal");
    ...
    xlim( time_lim );  grid on; box on; datetick('x','yyyy-mm' );
...
% print(gcf,'The_procedure_of_identifying_drought_events_on_a_daily_scale.png','-dpng','-r1600');     % set resolution, this perfect
